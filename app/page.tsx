        ...
        <div className="relative items-center w-full px-5 py-12 mx-auto lg:px-16 max-w-7xl md:px-12" >
          <div className='max-w-3xl mx-auto text-center'>
            <div>
              ...
              <p className='max-w-xl mx-auto mt-8 text-base lg:text-xl text-secondary-foreground'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat officia maiores magni molestias neque eaque</p>
            </div>
